...
def get_spf_record_text(resolver, domain_name, domain, follow_redirect=False):
    ...
    Errors are logged to the trustymail1.py.Domain object.  The Boolean
...
def scan(
    ...
    # and resolves before trustymail1.py finishes scanning the domain,
...
def handle_error(prefix, domain, error, syntax_error=False):
    ...
    trustymail1.py.Domain object.

    Since the "Debug Info" and "Syntax Error" fields in the CSV output
    of trustymail1.py come directly from the debug_info and syntax_error
    members of the trustymail1.py.Domain object, and that CSV is likely
    all we will have to reconstruct how trustymail1.py reached the
    ...
    prefix : str
        ...
        usually the type of trustymail1.py test that was being performed
    ...
    syntax_error : bool
        ...
        member of the trustymail1.py.Domain object.  Otherwise it is
        recorded in the error member of the trustymail1.py.Domain object.
    """
