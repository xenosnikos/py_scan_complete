...
# add_to_db = Queue(name='domainReputation_db_queue', connection=Redis(host=os.environ.get('REDIS_HOST')))
...
class DomainReputation(Resource):
    ...
    def post():
        ...
        #            'data': list_scans}
        #
        # add_to_db.enqueue(queue_to_db.domain_reputation_db_addition, message, retry=Retry(max=3, interval=[10, 30, 60]))
