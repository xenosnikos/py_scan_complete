...
.. doctest::
   ...
   >>> loads('[{"foo": [1, 2]}, {"bar": {"hello": "world"}}, {"code": {"$scope": {}, "$code": "function x() { return 1; }"}}, {"pshtt": {"$type": "80", "$binary": "AQIDBA=="}}]')
   [{u'foo': [1, 2]}, {u'bar': {u'hello': u'world'}}, {u'code': Code('function x() { return 1; }', {})}, {u'pshtt': Binary('...', 128)}]
...
.. doctest::
   ...
   ...        {'pshtt': Binary(b"\x01\x02\x03\x04")}])
   '[{"foo": [1, 2]}, {"bar": {"hello": "world"}}, {"code": {"$code": "function x() { return 1; }", "$scope": {}}}, {"pshtt": {"$binary": "AQIDBA==", "$type": "00"}}]'
...
.. doctest::
   ...
   '[{"foo": [{"$numberInt": "1"}, {"$numberInt": "2"}]}, {"bar": {"hello": "world"}}, {"code": {"$code": "function x() { return 1; }"}}, {"pshtt": {"$binary": {"base64": "AQIDBA==", "subType": "00"}}}]'
...
.. doctest::
   ...
   '[{"foo": [1, 2]}, {"bar": {"hello": "world"}}, {"code": {"$code": "function x() { return 1; }"}}, {"pshtt": {"$binary": {"base64": "AQIDBA==", "subType": "00"}}}]'
